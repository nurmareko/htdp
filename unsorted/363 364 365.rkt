...
#reader(lib "htdp-intermediate-lambda-reader.ss" "lang")((modname |363 364 365|) (read-case-sensitive #t) (teachpacks ()) (htdp-settings #(#t constructor repeating-decimal #f #t none #f () #f)))
; An Xexpr.v2 is:
;  (cons Symbol Body)
