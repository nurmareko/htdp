...
#reader(lib "htdp-intermediate-lambda-reader.ss" "lang")((modname |simplifying functions|) (read-case-sensitive #t) (teachpacks ((lib "batch-io.rkt" "teachpack" "2htdp") (lib "image.rkt" "teachpack" "2htdp") (lib "universe.rkt" "teachpack" "2htdp") (lib "itunes.rkt" "teachpack" "2htdp") (lib "web-io.rkt" "teachpack" "2htdp") (lib "abstraction.rkt" "teachpack" "2htdp"))) (htdp-settings #(#t constructor repeating-decimal #f #t none #f ((lib "batch-io.rkt" "teachpack" "2htdp") (lib "image.rkt" "teachpack" "2htdp") (lib "universe.rkt" "teachpack" "2htdp") (lib "itunes.rkt" "teachpack" "2htdp") (lib "web-io.rkt" "teachpack" "2htdp") (lib "abstraction.rkt" "teachpack" "2htdp")) #f)))
; An S-expr is one of: 
; – Atom
; – SL
...
(define (count sexp sy)
  (cond
    [(atom? sexp) (if (symbol=? sexp sy) 1 0)]
    [else (foldr + 0 (map (lambda (s) (count s sy)) sexp))]))
;=318================================================;
; S-expr -> N
...
(define (depth sexp)
  (cond
    [(atom? sexp) 1]
    [else (+ 1 (foldr max 0 (map depth sexp)))]))
;=319================================================;
