...
#reader(lib "htdp-intermediate-lambda-reader.ss" "lang")((modname |317 - 318|) (read-case-sensitive #t) (teachpacks ((lib "batch-io.rkt" "teachpack" "2htdp") (lib "image.rkt" "teachpack" "2htdp") (lib "universe.rkt" "teachpack" "2htdp") (lib "itunes.rkt" "teachpack" "2htdp") (lib "web-io.rkt" "teachpack" "2htdp") (lib "abstraction.rkt" "teachpack" "2htdp"))) (htdp-settings #(#t constructor repeating-decimal #f #t none #f ((lib "batch-io.rkt" "teachpack" "2htdp") (lib "image.rkt" "teachpack" "2htdp") (lib "universe.rkt" "teachpack" "2htdp") (lib "itunes.rkt" "teachpack" "2htdp") (lib "web-io.rkt" "teachpack" "2htdp") (lib "abstraction.rkt" "teachpack" "2htdp")) #f)))
; An S-expr is one of: 
; – Atom
; – SL
...
(define (substitute s old new)
  (local (; SL -> SL
          (define (subs-sl sl)
            (map (lambda (s) (substitute s old new)) sl))
          ; Atom -> Atom
          (define (subs-at at)
            (if (and (symbol? at) (equal? old at)) new at)))
    (cond
      [(atom? s) (subs-at s)]
      [else (subs-sl s)])))