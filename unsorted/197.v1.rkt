...
#reader(lib "htdp-beginner-abbr-reader.ss" "lang")((modname 197.v1) (read-case-sensitive #t) (teachpacks ((lib "batch-io.rkt" "teachpack" "2htdp") (lib "image.rkt" "teachpack" "2htdp") (lib "universe.rkt" "teachpack" "2htdp"))) (htdp-settings #(#t constructor repeating-decimal #f #t none #f ((lib "batch-io.rkt" "teachpack" "2htdp") (lib "image.rkt" "teachpack" "2htdp") (lib "universe.rkt" "teachpack" "2htdp")) #f)))
; On OS X: 
...
(define (most-frequent dict)
  (most-count (line-by-lo1s dict LETTERS)))

; LoLC -> Letter-Counts
; get letter-counts with the largest count number
(define (most-count li)
  (if (count> (first li) (first (rest li)))
      (first li)
      (most-count (rest li))))
