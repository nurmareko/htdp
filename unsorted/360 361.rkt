...
#reader(lib "htdp-intermediate-lambda-reader.ss" "lang")((modname |360 361|) (read-case-sensitive #t) (teachpacks ()) (htdp-settings #(#t constructor repeating-decimal #f #t none #f () #f)))
...
(define da-all (list con0 def0 def1))
;====================================================;
...
;(check-expect (eval-all 'close-to-pi da-all) con0)
...
;(check-error (eval-all (make-fun 'f 5) da-all) WRONG)
