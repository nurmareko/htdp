...
#reader(lib "htdp-intermediate-lambda-reader.ss" "lang")((modname |428 429 430|) (read-case-sensitive #t) (teachpacks ((lib "abstraction.rkt" "teachpack" "2htdp"))) (htdp-settings #(#t constructor repeating-decimal #f #t none #f ((lib "abstraction.rkt" "teachpack" "2htdp")) #f)))
...
(check-expect (quick-sort > (list 11 8 14 7)) '(14 11 8 7))
(check-expect (quick-sort > (list 5 1 2 1)) '(5 2 1 1))
