...
#reader(lib "htdp-beginner-abbr-reader.ss" "lang")((modname |221-222-223 tetris|) (read-case-sensitive #t) (teachpacks ((lib "batch-io.rkt" "teachpack" "2htdp") (lib "image.rkt" "teachpack" "2htdp") (lib "universe.rkt" "teachpack" "2htdp") (lib "itunes.rkt" "teachpack" "2htdp"))) (htdp-settings #(#t constructor repeating-decimal #f #t none #f ((lib "batch-io.rkt" "teachpack" "2htdp") (lib "image.rkt" "teachpack" "2htdp") (lib "universe.rkt" "teachpack" "2htdp") (lib "itunes.rkt" "teachpack" "2htdp")) #f)))
...
;===================================================;
; Tetris -> Boolean
; has landscape reach top?
(define (end? s)
  (reach-top? (tetris-landscape s)))

; Landscape -> Boolean
; has landscape reach top?
(define (reach-top? li)
  (cond [(empty? li) #false]
        [(= (block-y (first li)) 0) #true]
        [else #false]))
...
(check-expect
 (on-edge? (make-block (* 10 SIZE) (* 0 SIZE))
           "right") #true)
(check-expect
 (end? (make-tetris (make-block 90 0)
                    (list (make-block 40 0))))
 #true)
(check-expect (end? tetris0) #false)
(check-expect (end? tetris1) #false)