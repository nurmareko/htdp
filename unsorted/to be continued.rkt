...
#reader(lib "htdp-intermediate-lambda-reader.ss" "lang")((modname |to be continued|) (read-case-sensitive #t) (teachpacks ((lib "image.rkt" "teachpack" "2htdp"))) (htdp-settings #(#t constructor repeating-decimal #f #t none #f ((lib "image.rkt" "teachpack" "2htdp")) #f)))
; An Xexpr.v2 is:
;  (cons Symbol Body)
...
(check-expect
 ...
 (beside/align 'center (circle 2 "solid" "black") (text "Hello World" 12 'black)))
