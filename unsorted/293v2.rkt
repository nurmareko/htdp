...
#reader(lib "htdp-intermediate-lambda-reader.ss" "lang")((modname 293v2) (read-case-sensitive #t) (teachpacks ((lib "batch-io.rkt" "teachpack" "2htdp") (lib "image.rkt" "teachpack" "2htdp") (lib "universe.rkt" "teachpack" "2htdp") (lib "itunes.rkt" "teachpack" "2htdp") (lib "web-io.rkt" "teachpack" "2htdp"))) (htdp-settings #(#t constructor repeating-decimal #f #t none #f ((lib "batch-io.rkt" "teachpack" "2htdp") (lib "image.rkt" "teachpack" "2htdp") (lib "universe.rkt" "teachpack" "2htdp") (lib "itunes.rkt" "teachpack" "2htdp") (lib "web-io.rkt" "teachpack" "2htdp")) #f)))
...
(check-expect [(found? 0 '(1 0 1 0 0)) 0] #false)
(check-expect [(found? 0 '(1 0 1 0 0)) '("a")] #false)

(define (found? x lx)
  (lambda (rs)
    (if (empty? lx) (false? rs)
        (cond
          [(false? rs) (not (member? x lx))]
          [(and (list? rs) (not (empty? rs)))
           (and (equal? x (first rs)) (sublist? rs lx))]
          [else #false]))))
;====================================================;
