...
#reader(lib "htdp-intermediate-lambda-reader.ss" "lang")((modname |475 new|) (read-case-sensitive #t) (teachpacks ()) (htdp-settings #(#t constructor repeating-decimal #f #t none #f () #f)))
; A Node is a Symbol.
...
(define (find-path origination destination G)
  (local (; Node -> [Maybe Path]
          ...
          (define (find-path/list lo-Os)
            (foldr (lambda (node re)
                     (local ((define candidate (find-path node)))
