...
#reader(lib "htdp-intermediate-lambda-reader.ss" "lang")((modname |474|) (read-case-sensitive #t) (teachpacks ((lib "abstraction.rkt" "teachpack" "2htdp") (lib "image.rkt" "teachpack" "2htdp") (lib "batch-io.rkt" "teachpack" "2htdp"))) (htdp-settings #(#t constructor repeating-decimal #f #t none #f ((lib "abstraction.rkt" "teachpack" "2htdp") (lib "image.rkt" "teachpack" "2htdp") (lib "batch-io.rkt" "teachpack" "2htdp")) #f)))
  ...
  (cond
    ...
    [else (local (; Node Graph -> [List-of Node]
                  ...
                  (define (find-path/list lo-Os D G)
                    (foldr (lambda (x re)
                             (local ((define candidate (find-path x D G)))
