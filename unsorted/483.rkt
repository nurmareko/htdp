...
#reader(lib "htdp-intermediate-lambda-reader.ss" "lang")((modname |483|) (read-case-sensitive #t) (teachpacks ((lib "image.rkt" "teachpack" "2htdp"))) (htdp-settings #(#t constructor repeating-decimal #f #t none #f ((lib "image.rkt" "teachpack" "2htdp")) #f)))
(define QUEENS 8)
; A QP is a structure:
;   (make-posn CI CI)
...
(define BOARD1-EMPTY ; an empty 4 by 4 board.
  (list (list #false #false #false #false)
        (list #false #false #false #false)
        (list #false #false #false #false)
        (list #false #false #false #false)))

(define BOARD1 ; a board with one queen placed at (1, 1)
  (list (list #false #false #false #false)
        (list #false 1-1    #false #false)
        (list #false #false #false #false)
        (list #false #false #false #false)))

;====================================================;
; a Board is a grid of n by n squares, each possibly
; occupied by a queen. Use a structure with three
; fields to represent a square: one for x, one for y,
; and a third one saying whether the square is
; threatened.
