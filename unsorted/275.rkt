...
#reader(lib "htdp-intermediate-reader.ss" "lang")((modname |275|) (read-case-sensitive #t) (teachpacks ((lib "batch-io.rkt" "teachpack" "2htdp") (lib "image.rkt" "teachpack" "2htdp") (lib "universe.rkt" "teachpack" "2htdp") (lib "itunes.rkt" "teachpack" "2htdp") (lib "web-io.rkt" "teachpack" "2htdp"))) (htdp-settings #(#t constructor repeating-decimal #f #t none #f ((lib "batch-io.rkt" "teachpack" "2htdp") (lib "image.rkt" "teachpack" "2htdp") (lib "universe.rkt" "teachpack" "2htdp") (lib "itunes.rkt" "teachpack" "2htdp") (lib "web-io.rkt" "teachpack" "2htdp")) #f)))
  ...
  (local (; make list of Letter Counts
          (define listed-LC
            (local (; 1String -> Letter-Counts
                    (define (create-LC s)
                      (make-LC s (count s dic))))
              ; - IN -
              (map create-LC LETTERS)))
          ; sorted list of Letter Counts in ascending
          ; order.
          (define sorted-max
            (local (; Letter-Counts Letter-Counts
                    ; -> Boolean
                    (define (max? a b)
...
; count how many times 1-s is use as the first letter
; inside ls.
(define (count 1-s ls)
