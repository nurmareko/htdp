...
#reader(lib "htdp-intermediate-lambda-reader.ss" "lang")((modname |335|) (read-case-sensitive #t) (teachpacks ((lib "batch-io.rkt" "teachpack" "2htdp") (lib "image.rkt" "teachpack" "2htdp") (lib "universe.rkt" "teachpack" "2htdp") (lib "itunes.rkt" "teachpack" "2htdp") (lib "web-io.rkt" "teachpack" "2htdp") (lib "abstraction.rkt" "teachpack" "2htdp"))) (htdp-settings #(#t constructor repeating-decimal #f #t none #f ((lib "batch-io.rkt" "teachpack" "2htdp") (lib "image.rkt" "teachpack" "2htdp") (lib "universe.rkt" "teachpack" "2htdp") (lib "itunes.rkt" "teachpack" "2htdp") (lib "web-io.rkt" "teachpack" "2htdp") (lib "abstraction.rkt" "teachpack" "2htdp")) #f)))
...
(define (how-many d)
  (+ (for-dir* (dir.v3-dirs d))
     (for-file* (dir.v3-files d))))
;====================================================;
; Dir* -> Number
; count file in Dirs,ld.

(check-expect (for-dir* `(,Text ,Libs)) 6)
...
;====================================================;
; File* -> Number
; count file in files, lf.

(check-expect (for-file* `(,read!-0)) 1)
